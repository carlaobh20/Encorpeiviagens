  ...
  return (
    <div className="max-w-sm mx-auto min-h-screen flex flex-col justify-center px-6">
      ...
      <div className="space-y-3">
        <input placeholder="Nome completo" className="w-full rounded-2xl bg-card2 border border-white/10 px-4 py-3.5 text-sm outline-none focus:border-turq/50" />
        ...
        <GradientButton className="w-full">Criar conta</GradientButton>
      </div>
